...
std::size_t median_of_three(std::vector<int> &v, std::size_t left, std::size_t right)
{
...
std::size_t hoar_partition(std::vector<int> &v, std::size_t left, std::size_t right)
{
...
void quicksort(std::vector<int> &v, std::size_t left, std::size_t right)
{
    if (right - left <= 16)
    {
        order(v, left, right);
